...
import meg.biblio.lending.db.dao.PersonDaoIntegrationTest;
...
privileged aspect PersonDaoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: PersonDaoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: PersonDaoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: PersonDaoIntegrationTest: @Transactional;
    
    @Autowired
    PersonDaoDataOnDemand PersonDaoIntegrationTest.dod;
    
    @Autowired
    PersonRepository PersonDaoIntegrationTest.personRepository;
    
    @Test
    public void PersonDaoIntegrationTest.testCount() {
    ...
    @Test
    public void PersonDaoIntegrationTest.testFind() {
    ...
    @Test
    public void PersonDaoIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", dod.getRandomPersonDao());
        long count = personRepository.count();
    ...
    @Test
    public void PersonDaoIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", dod.getRandomPersonDao());
        long count = personRepository.count();
    ...
    @Test
    public void PersonDaoIntegrationTest.testFlush() {
        PersonDao obj = dod.getRandomPersonDao();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to provide an identifier", id);
    ...
    @Test
    public void PersonDaoIntegrationTest.testSaveUpdate() {
        PersonDao obj = dod.getRandomPersonDao();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to provide an identifier", id);
    ...
    @Test
    public void PersonDaoIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", dod.getRandomPersonDao());
    ...
    @Test
    public void PersonDaoIntegrationTest.testDelete() {
        PersonDao obj = dod.getRandomPersonDao();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'PersonDao' failed to provide an identifier", id);
