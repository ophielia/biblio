...
import meg.biblio.inventory.db.dao.InventoryHistoryDaoIntegrationTest;
...
privileged aspect InventoryHistoryDaoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: InventoryHistoryDaoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: InventoryHistoryDaoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: InventoryHistoryDaoIntegrationTest: @Transactional;
    
    @Autowired
    InventoryHistoryDaoDataOnDemand InventoryHistoryDaoIntegrationTest.dod;
    
    @Autowired
    InventoryHistRepository InventoryHistoryDaoIntegrationTest.inventoryHistRepository;
    
    @Test
    public void InventoryHistoryDaoIntegrationTest.testCount() {
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testFind() {
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", dod.getRandomInventoryHistoryDao());
        long count = inventoryHistRepository.count();
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", dod.getRandomInventoryHistoryDao());
        long count = inventoryHistRepository.count();
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testFlush() {
        InventoryHistoryDao obj = dod.getRandomInventoryHistoryDao();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to provide an identifier", id);
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testSaveUpdate() {
        InventoryHistoryDao obj = dod.getRandomInventoryHistoryDao();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to provide an identifier", id);
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", dod.getRandomInventoryHistoryDao());
    ...
    @Test
    public void InventoryHistoryDaoIntegrationTest.testDelete() {
        InventoryHistoryDao obj = dod.getRandomInventoryHistoryDao();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InventoryHistoryDao' failed to provide an identifier", id);
