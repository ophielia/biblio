...
public class RoleDaoDataOnDemand {
    ...
    public RoleDao getNewTransientRoleDao(int index) {
        RoleDao obj = new RoleDao();
        setRolename(obj, index);
        return obj;
    }

    public RoleDao getSpecificRoleDao(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public RoleDao getRandomRoleDao() {
        init();
    ...
    public boolean modifyRoleDao(RoleDao obj) {
        return false;
    }
