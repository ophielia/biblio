...
privileged aspect ImportBookDaoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ImportBookDaoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ImportBookDaoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ImportBookDaoIntegrationTest: @Transactional;
    
    @Autowired
    ImportBookDaoDataOnDemand ImportBookDaoIntegrationTest.dod;
    
    @Autowired
    ImportBookRepository ImportBookDaoIntegrationTest.importBookRepository;
    
    @Test
    public void ImportBookDaoIntegrationTest.testCount() {
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testFind() {
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", dod.getRandomImportBookDao());
        long count = importBookRepository.count();
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", dod.getRandomImportBookDao());
        long count = importBookRepository.count();
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testFlush() {
        ImportBookDao obj = dod.getRandomImportBookDao();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to provide an identifier", id);
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testSaveUpdate() {
        ImportBookDao obj = dod.getRandomImportBookDao();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to provide an identifier", id);
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", dod.getRandomImportBookDao());
    ...
    @Test
    public void ImportBookDaoIntegrationTest.testDelete() {
        ImportBookDao obj = dod.getRandomImportBookDao();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ImportBookDao' failed to provide an identifier", id);
