...
public class InventoryServiceImpl implements InventoryService {
    ...
    public void clearStackForUser(Long userid, ClientDao client) {
        ...
        Path<Long> userIdPath = bookroot.get("userid");
        q.set(userIdPath, nullLong);
    ...
    private int clearInventoryDataInBooks(Long clientid) {
        ...
        Path<Long> countStatusPath = bookroot.get("countstatus");
        Path<Date> countedDatePath = bookroot.get("counteddate");
        Path<Long> userIdPath = bookroot.get("userid");
        q.set(countStatusPath, nullLong);
        q.set(countedDatePath, nullDate);
        q.set(userIdPath, nullLong);
...
// TODO -
//    cross check inventory on return of books
/*
