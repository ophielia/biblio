// mydojo/widget/ShelfClassWidget.js
define([
    "dojo/_base/declare",
    "dojo/_base/fx",
    "dojo/_base/lang",
    ...
    "dojo/text!./templates/ShelfClassWidget.html"
], function(declare, baseFx, lang, domStyle, mouse, on, _WidgetBase, _TemplatedMixin, template){
    return declare([_WidgetBase, _TemplatedMixin], {
        // Some default values for our author
        // These typically map to whatever you're passing to the constructor
        textdisplay: "this space for rent",

        // Using require.toUrl, we can get a path to our AuthorWidget's space
        // and we want to have a default avatar, just in case
        imageDisplay: require.toUrl("/biblio/resources/mydojo/widget/images/blank.png"),
        description: "",
		...
		_setImagedisplayAttr: function(imagePath) {
			// We only want to set it if it's a non-empty string
			if (imagePath != "") {
				// Save it on our widget instance - note that
				// we're using _set, to support anyone using
				// our widget's Watch functionality, to watch values change
				this._set("imagedisplay", imagePath);

				// Using our avatarNode attach point, set its src value
				this.imageDisplayNode.src = imagePath;
			}
		}
